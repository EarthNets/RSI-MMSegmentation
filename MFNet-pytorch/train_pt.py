...
if __name__ == '__main__':
    ...
    checkpoint_model_file = os.path.join(model_dir, 'PT_tmp.pth')
    checkpoint_optim_file = os.path.join(model_dir, 'PT_tmp.optim')
    final_model_file      = os.path.join(model_dir, 'PT_resnet_final.pth')
    log_file              = os.path.join(model_dir, 'PT_resnetlog.txt')
