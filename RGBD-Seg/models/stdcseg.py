...
class ContextPath(nn.Module):
    ...
    def forward(self, x, d):
        ...
        feat2r, feat4r, feat8r, feat16r, feat32r = self.backbone(x)
        d3 = torch.cat([d,d,d],1)
        feat2d, feat4d, feat8d, feat16d, feat32d = self.backbone(d3)
        feat2 = feat2d + feat2r
        feat4 = feat4d + feat4r
        feat8 = feat8d + feat8r
        feat16 = feat16d + feat16r
        feat32 = feat32d + feat32r
        H8, W8 = feat8.size()[2:]
...
class BiSeNet(nn.Module):
    ...
    def forward(self, x, d):
        ...
        feat_res2, feat_res4, feat_res8, feat_res16, feat_cp8, feat_cp16 = self.cp(x,d)
